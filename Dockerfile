...
LABEL "traefik.http.routers.www-shoogland-com-http.middlewares"="www-redirect"
...
LABEL "traefik.http.routers.shoogland-com-http.middlewares"="www-redirect"
...
LABEL "traefik.http.routers.shoogland-com-https.middlewares"="www-redirect"
LABEL "traefik.http.middlewares.www-redirect.redirectregex.regex"="^https?:\/\/(www\.)?shoogland\.com\/?(.*)$"
LABEL "traefik.http.middlewares.www-redirect.redirectregex.replacement"="https://www.shoogland.com/\${2}"
